...
app.generateHighscoreOverlay = function(context) {
  ...
  $(`<div class="overlay" role="dialog"><div class="overlay__contents"><div class="highscores highscores--${app.level}"><h2 class="highscores__title">Highscores</h2><div class="highscores__buttons"><button class="highscores__button highscores__button--easy">Easy</button><button class="highscores__button highscores__button--medium">Medium</button><button class="highscores__button highscores__button--hard">Hard</button></div><table class="highscores__table highscores__table--easy"><tr><td><span class="accessible">Rank</span></td><td>Name</td><td>Score</td><td>Time</td><td>Clicks</td></tr></table><table class="highscores__table highscores__table--medium"><tr><td><span class="accessible">Rank</span></td><td>Name</td><td>Score</td><td>Time</td><td>Clicks</td></tr></table><table class="highscores__table highscores__table--hard"><tr><td><span class="accessible">Rank</span></td><td>Name</td><td>Score</td><td>Time</td><td>Clicks</td></tr></table></div></div></div>`).hide().appendTo('main').fadeIn(200);
